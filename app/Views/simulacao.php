...
<?php if(isset($simulacao['simulacao_id'])){?>
    ...
    <form method="post" name="frmAdd" action="<?php echo site_url('calculo');?>">
        <h5 class="align-self-center d-flex justify-content-center mt-5">Edição de Simulação </h5>
        ...
        <div class="row  align-self-center d-flex justify-content-center">
            <div class="col-10 col-md-4">
                ...
                <div class="form-group"> 
                    <label> % Ml De Óleo Essencial</label> 
                    <input type="text"  placeholder="0 a 100" pattern="[0-9.]+$" class="form-control"   name="mloe_por_cento" value="<?=$simulacao['mloe_por_cento']?>" id="mloe_por_cento" required>
                </div>
                <div class="form-group"> 
                ...
                <div class="form-group">
                    ...
                    <option value="<?=$simulacao['id_oleo_base']." - ".$simulacao['preco_ml']." - ".$simulacao['nome_oleo_base'] ?>" selected><?= "Óleo Base/ml: ".$simulacao['nome_oleo_base']." / ".$simulacao['ml_antes'] ?></option>
                ...
                <div class="form-group">
                    ...
                    <option value="<?=$data3['obase2']['id']." - ".$data3['obase2']['preco_ml']." - ".$data3['obase2']['nome'] ?>" selected><?= "Óleo Base/ml: ".$data3['obase2']['nome']." / ".$data3['obase2']['ml_antes'] ?></option>
                        <?php foreach($query4 as $ob){?>
                            <option value="<?=$ob['id']." - ".$ob['preco_ml']." - ".$ob['nome']?>"><?= "Óleo Base/ml: ".$ob['nome']." / ".$ob['ml'] ?></option>
                        <?php } ?>  
                    </select> 
                ...
                <label>Óleo Essencial 1</label>
                    ...
                    <option value="<?=$simulacao['id_oleo_essencial1']." - ".$data3['oess']['preco_gota']." - ".$simulacao['oleo_essencial1']?>"selected><?= "Óleo Essencial/gotas: ".$simulacao['oleo_essencial1']." - ".$data3['oess']['t_gotas_antes'] ?></option>
                ...
                <div class="form-group">
                    ...
                    <option value="<?=$simulacao['id_oleo_essencial2']." - ".$data3['oess2']['preco_gota']." - ".$simulacao['oleo_essencial2']?>"selected><?= "Óleo Essencial/gotas: ".$simulacao['oleo_essencial2']." - ".$data3['oess2']['t_gotas_antes'] ?></option>
                        <?php foreach($query5 as $cliente){?>
                            <option value="<?=$cliente['id']." - ".$cliente['preco_gota']." - ".$cliente['nome']?>"><?= "Óleo Essencial/gotas: ".$cliente['nome']." - ".$cliente['total_gotas'] ?></option>
                        <?php } ?>  
                    </select>
            ...
            <div class="col-10 col-md-4">        
                <div class="form-group">
                    ...
                    <option value="<?=$simulacao['id_oleo_essencial3']." - ".$data3['oess3']['preco_gota']." - ".$simulacao['oleo_essencial3']?>"selected><?= "Óleo Essencial/gotas: ".$simulacao['oleo_essencial3']." - ".$data3['oess3']['t_gotas_antes'] ?></option>
                ...
                <div class="form-group">
                    ...
                    <option value="<?=$simulacao['id_oleo_essencial4']." - ".$data3['oess4']['preco_gota']." - ".$simulacao['oleo_essencial4']?>"selected><?= "Óleo Essencial/gotas: ".$simulacao['oleo_essencial4']." - ".$data3['oess4']['t_gotas_antes'] ?></option>
                        <?php foreach($query5 as $cliente){?>
                            <option value="<?=$cliente['id']." - ".$cliente['preco_gota']." - ".$cliente['nome']?>"><?= "Óleo Essencial/gotas: ".$cliente['nome']." - ".$cliente['total_gotas'] ?></option>
                        <?php } ?>  
                    </select>
                ...
                <div class="form-group">
                    ...
                    <option value="<?=$simulacao['id_oleo_essencial5']." - ".$data3['oess5']['preco_gota']." - ".$simulacao['oleo_essencial4']?>"selected><?= "Óleo Essencial/gotas: ".$simulacao['oleo_essencial4']." - ".$data3['oess5']['t_gotas_antes'] ?></option>
                        <?php foreach($query5 as $cliente){?>
                            <option value="<?=$cliente['id']." - ".$cliente['preco_gota']." - ".$cliente['nome']?>"><?= "Óleo Essencial/gotas: ".$cliente['nome']." - ".$cliente['total_gotas'] ?></option>
                        <?php } ?>  
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select id="oe6" class="custom-select" name="oleo_essencial_6"   >
                        <option value="<?=$simulacao['id_oleo_essencial6']." - ".$data3['oess6']['preco_gota']." - ".$simulacao['oleo_essencial6']?>"selected><?= "Óleo Essencial/gotas: ".$simulacao['oleo_essencial6']." - ".$data3['oess6']['t_gotas_antes'] ?></option>
                ...
                <input type="hidden"  name="id" value="<?=isset($simulacao['simulacao_id'])? $simulacao['simulacao_id'] : set_value('simulacao_id')?>" >
            </div><!-- coluna 2 --> 
    ...
    <?php }else{ ?>
        ...
        <form method="post" name="frmAdd" action="<?php echo site_url('calculo');?>">
            <h5 class="align-self-center d-flex justify-content-center mt-5">Simulação</h5>
            <div class="container">
                ...
                <div class="row align-self-center d-flex justify-content-center ">
                        ...
                        <div class="col-10 col-md-4">
                            ...
                            <div class="form-group">
                                <label>Nome Da Simulação</label>
                                <input type="text" name="nome_simulacao" class="form-control">
                            </div>
                        
                            <div class="form-group">
                                
                                <label> Ml de Óleo Essencial</label>
                                <input type="number"  class="form-control" name="ml_o_essencial" id="ml_o_essencial" min="0" max="1000" required>
                                
                            </div>
                            <div class="form-group"> 
                                <label> % Ml De Óleo Essencial</label> 
                                <input type="text"  placeholder="0 a 100" pattern="[0-9.]+$" class="form-control"   name="mloe_por_cento" id="mloe_por_cento" required>
                            </div>
                            <div class="form-group"> 
                                <label> Total de Gotas de Óleo Essencial:</label>
                                <input type="number"  class="form-control" name="total_gotas_oe" id="total_gotas_oe" value="0" readonly >
                            ...
                            <div class="form-group">
                                <label> Ml de Óleo base</label>
                                <input type="number"  class="form-control" name="ml_oleo_base" id="ml_oleo_base" min="0" max="1000" required>
                                <span id="msgmlob"></span>
                            </div>
                            <div class="form-group">
                                <label> Óleo base 2</label>
                            ...
                            <div class="form-group">
                                <label> Ml de Óleo base 2</label>
                                <input type="number"  class="form-control" name="ml_oleo_base2" id="ml_oleo_base2" min="0" max="1000" >
                                <span id="msgmlob2"></span>
                            </div>
                            <div class="form-group">
                            <label>Óleo Essencial 1</label>
                                <select id="oe1" class="custom-select" name="oleo_essencial_1" required>
                                    <option value=""  selected>Escolher...</option>
                                    <?php foreach($query5 as $cliente){?>
                                        <option value="<?=$cliente['id']." - ".$cliente['preco_gota']." - ".$cliente['nome']?>"><?= "Óleo Essencial/gotas: ".$cliente['nome']." - ".$cliente['total_gotas'] ?></option>
                                    <?php } ?>  
                            ...
                            <div class="form-group">
                                <label> Gota de Óleo Essencial 1</label>
                                <input type="number"  class="form-control" name="gota_essencial_1" min="0" max="1000" id="goe1" required>
                                <span id="msggoe1"></span>
                            </div>
                            <div class="form-group">
                                <label>Óleo Essencial 2</label>
                            ...
                            <div class="form-group">
                                <label> Gota de Óleo Essencial 2</label>
                                <input type="number"  class="form-control" name="gota_essencial_2" min="0" max="1000" id="goe2">
                                <span id="msggoe2"></span>     
                            </div>
                        ...
                        <div class="col-10 col-md-4">        
                            ...
                            <div class="form-group">
                                <label> Gota de Óleo Essencial 3</label>
                                <input type="number"  class="form-control" name="gota_essencial_3" min="0" max="1000" id="goe3">
                                <span id="msggoe3"></span>
                            </div>
                            <div class="form-group">
                                <label>Óleo Essencial 4</label>
                            ...
                            <div class="form-group">
                                <label> Gota de Óleo Essencial 4</label>
                                <input type="number"  class="form-control" name="gota_essencial_4" min="0" max="1000" id="goe4">
                                <span id="msggoe4"></span>
                            </div>
                            <div class="form-group">
                                <label>Óleo Essencial 5</label>
                            ...
                            <div class="form-group">
                                <label> Gota de Óleo Essencial 5</label>
                                <input type="number"  class="form-control" name="gota_essencial_5" min="0" max="1000" id="goe5">
                                <span id="msggoe5"></span>
                            </div>
                            <div class="form-group">
                                <label>Óleo Essencial 6</label>
                            ...
                            <div class="form-group">
                                <label> Gota de Óleo Essencial 6</label>
                                <input type="number"  class="form-control" name="gota_essencial_6" min="0" max="1000" id="goe6">
                                <span id="msggoe6"></span>
                            </div>
                            <div class="form-group">
                                <label>lucro %</label>
                                <input type="number"  class="form-control" name="porcentagem_lucro" min="1" max="1000" required>
                            </div> 
                            <div class="form-group">
                                <label> Acessório</label>
                                <select id="select" class="custom-select" name="acessorio" id="acessorio">
