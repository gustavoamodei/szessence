<div class="container">
        ...
        <?php if($session->getFlashdata('msg')){?>
            ...
            <a href="<?= base_url('cadastro_cliente')?>" class="btn btn-success mb-3">Cadastrar</a>
            <h5 class="align-self-center d-flex justify-content-center">Clientes<h5>
            <div class="table-responsive">
                <table class=" table table-sm table-bordered table-hover" id="table_cliente">
                    ...
                    <tbody>
                            ...
                            <?php  foreach($query as $c){ ?>
                                    <tr>
                                        ...
                                        <td><?=$c['email'] ?></td>
                                        <td>
                                            <a href="<?=base_url('edit_cliente/'.$c['id'])?>" class="btn btn-primary">Edit</a>
