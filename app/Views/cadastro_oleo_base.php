...
<?=$validation->listErrors(); ?>
    <?php if(isset($id)){ ?>
        ...
        <form method="post" name="frmAdd" action="<?php echo site_url('store_oleo_base');?>">
            <h5 class="align-self-center d-flex justify-content-center mt-3"> Edição de óleos Base </h5>
            ...
            <div class="row  align-self-center d-flex justify-content-center">
                <div class="col-10 col-md-5">
                    ...
                    <div class="form-group">
                        <label>Ml</label>
                        <input type="text" class="form-control"  name="ml" value="<?=isset($ml)? $ml : set_value('ml')?>" required>
                    </div>
                    <div class="form-group">
...
<?php }else{ ?>
    <form method="post" name="frmAdd" action="<?php echo site_url('store_oleo_base');?>">
        <h5 class="align-self-center d-flex justify-content-center mt-3">Cadastro de óleos Base </h5>
