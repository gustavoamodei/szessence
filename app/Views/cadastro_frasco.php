...
<?=$validation->listErrors(); ?>
    <?php if(isset($id)){ ?>
        ...
        <form method="post" name="frmAdd" action="<?php echo site_url('store_frasco');?>">
            <h5 class="align-self-center d-flex justify-content-center mt-5"> Edição de Frasco  </h5>
    ...
    <?php }else{ ?>
    <form method="post" name="frmAdd" action="<?php echo site_url('store_frasco');?>">
        <h5 class="align-self-center d-flex justify-content-center mt-5"> Cadastro de Frasco</h5>
